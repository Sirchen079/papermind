...
import { type ResearchProgressReport } from "../api";
import {
...
import { researchActionLocation, type NavLocation } from "../pages/navigationModel";
              ...
              return (
                <div key={action.id} className="rounded-lg px-3 py-2" style={{ backgroundColor: "var(--surface-2)" }}>
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button
                      onClick={() => onNavigate?.(researchActionLocation(action.id, action.route))}
